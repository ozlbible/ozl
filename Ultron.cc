-- // leaked idc skid off it @ozlbible go buy new updated version serpent.cc
...
local DLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/killer1854185815/other/main/svbdvbcdfbdfaghsrdfgaes/3d%20drawings"))()
...
local KILLMEKILLMEKILLME = Instance.new("MeshPart")
KILLMEKILLMEKILLME.MeshId = "rbxassetid://3726303797"
KILLMEKILLMEKILLME.CanCollide = false
KILLMEKILLMEKILLME.Anchored = true
KILLMEKILLMEKILLME.Material = Enum.Material.Neon
KILLMEKILLMEKILLME.Parent = game.Workspace
KILLMEKILLMEKILLME.CFrame = CFrame.new(9999,9999,9999)
KILLMEKILLMEKILLME.Size = Vector3.new(2 * 0.7, 7, 2 * 0.7)
KILLMEKILLMEKILLME.Color = Color3.fromRGB(255,255,255)



local WSDFEOJIHWESDFOUHIWGERSFOUHIGWREOUIHWEGROILUHJWERGOLHIJWREGHOILUWERGOILUHWERGOLHUIWEG4OHLUIWEG4 = DLib:New3DCube()
WSDFEOJIHWESDFOUHIWGERSFOUHIGWREOUIHWEGROILUHJWERGOLHIJWREGHOILUWERGOILUHWERGOLHUIWEG4OHLUIWEG4.ZIndex = 4 
WSDFEOJIHWESDFOUHIWGERSFOUHIGWREOUIHWEGROILUHJWERGOLHIJWREGHOILUWERGOILUHWERGOLHUIWEG4OHLUIWEG4.Visible = false 
WSDFEOJIHWESDFOUHIWGERSFOUHIGWREOUIHWEGROILUHJWERGOLHIJWREGHOILUWERGOILUHWERGOLHUIWEG4OHLUIWEG4.Transparency = 0.5 
WSDFEOJIHWESDFOUHIWGERSFOUHIGWREOUIHWEGROILUHJWERGOLHIJWREGHOILUWERGOILUHWERGOLHUIWEG4OHLUIWEG4.Color = Color3.fromRGB(255,255,255)
WSDFEOJIHWESDFOUHIWGERSFOUHIGWREOUIHWEGROILUHJWERGOLHIJWREGHOILUWERGOILUHWERGOLHUIWEG4OHLUIWEG4.Thickness = 1 
WSDFEOJIHWESDFOUHIWGERSFOUHIGWREOUIHWEGROILUHJWERGOLHIJWREGHOILUWERGOILUHWERGOLHUIWEG4OHLUIWEG4.Filled = true 
WSDFEOJIHWESDFOUHIWGERSFOUHIGWREOUIHWEGROILUHJWERGOLHIJWREGHOILUWERGOILUHWERGOLHUIWEG4OHLUIWEG4.Position = LocalPlayer.Character.HumanoidRootPart.Position
WSDFEOJIHWESDFOUHIWGERSFOUHIGWREOUIHWEGROILUHJWERGOLHIJWREGHOILUWERGOILUHWERGOLHUIWEG4OHLUIWEG4.Size = Vector3.new(1,1,1)


local IWANTOENDITALLLLLLIWANTOTJIAESIOUHWEEWRIUOEWOHUIWEOHRUOUEWHIOUIEWHHHHOWEUO = game:GetObjects("rbxassetid://8246626421")[1]
IWANTOENDITALLLLLLIWANTOTJIAESIOUHWEEWRIUOEWOHUIWEOHRUOUEWHIOUIEWHHHHOWEUO.Humanoid:Destroy()
IWANTOENDITALLLLLLIWANTOTJIAESIOUHWEEWRIUOEWOHUIWEOHRUOUEWHIOUIEWHHHHOWEUO.Head.Face:Destroy()
IWANTOENDITALLLLLLIWANTOTJIAESIOUHWEEWRIUOEWOHUIWEOHRUOUEWHIOUIEWHHHHOWEUO.Parent = game.Workspace
IWANTOENDITALLLLLLIWANTOTJIAESIOUHWEEWRIUOEWOHUIWEOHRUOUEWHIOUIEWHHHHOWEUO.HumanoidRootPart.Velocity = Vector3.new()
IWANTOENDITALLLLLLIWANTOTJIAESIOUHWEEWRIUOEWOHUIWEOHRUOUEWHIOUIEWHHHHOWEUO.HumanoidRootPart.CFrame = CFrame.new(9999,9999,9999)

local FAGGOTFAGGOTFAGGOTSEX = Drawing.new("Circle")
FAGGOTFAGGOTFAGGOTSEX.Visible = false 
FAGGOTFAGGOTFAGGOTSEX.Radius = 8
FAGGOTFAGGOTFAGGOTSEX.Thickness = 0 
FAGGOTFAGGOTFAGGOTSEX.Color = Color3.fromRGB(0,0,0)
FAGGOTFAGGOTFAGGOTSEX.Filled = true
FAGGOTFAGGOTFAGGOTSEX.ZIndex = 1

local DETECTORDICKDICKFUCKYOUNIGGASXHUTUPOSLUIT = Drawing.new("Circle")
DETECTORDICKDICKFUCKYOUNIGGASXHUTUPOSLUIT.Visible = false 
DETECTORDICKDICKFUCKYOUNIGGASXHUTUPOSLUIT.Radius = 8
DETECTORDICKDICKFUCKYOUNIGGASXHUTUPOSLUIT.Thickness = 0 
DETECTORDICKDICKFUCKYOUNIGGASXHUTUPOSLUIT.Color = Color3.fromRGB(0,0,0)
DETECTORDICKDICKFUCKYOUNIGGASXHUTUPOSLUIT.Filled = true
DETECTORDICKDICKFUCKYOUNIGGASXHUTUPOSLUIT.ZIndex = 1
...
local AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = {
    AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = newDrawing("Square", {
        AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = Vector2.new(150, 25),
        AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = Vector2.new(22,41),
        AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = Color3.fromRGB(0, 0, 0),
        AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = true,
        AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = false,
 }),
 AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = newDrawing("Square", {
    AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = Vector2.new(1,1),
    AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = Vector2.new(1,1),
    AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = Color3.fromRGB(50,50,50),
    AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = true,
    AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = false,
 }),
 AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = newDrawing("Image", {
    AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = Vector2.new(1,1),
    AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = Vector2.new(1,1),
    AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = false,
    AZAZAZZAZAZZAZAZAZAZAAZAZZZAAAAAZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAZZZZZZZZZ = game:HttpGet("https://i.imgur.com/5hmlrjX.png")
 }),
...
do
    ...
    local menu = library.new("Ozl", "Ozl Config Folder\\")
        local tabs = {
