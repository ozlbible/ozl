...
-- // Shorthand
local uwuOZL = getgenv().OZL
local uwuMain = uwuOZL.General
local uwuCamMain = uwuOZL.Camlock.Main
local uwuCamFOV = uwuOZL.Camlock.FOV
local uwuSilentMain = uwuOZL.Silent.Main
local uwuSilentFOV = uwuOZL.Silent.FOV
local uwuTrace = uwuOZL.Tracer
local uwuAutoPred = uwuOZL.AutoPrediction
...
local function SendNotification(text)
    Notification:Notify(
        {Title = "OZL", Description = "The Most COMP script - "..text},
        {OutlineColor = Color3.fromRGB(50,76,110),Time = 2, Type = "image"},
        {Image = "https://create.roblox.com/marketplace/asset/13322146212/IMG0560", ImageColor = Color3.fromRGB(128,0,128)}
    )
end 

-- // Call notification function
if uwuMain.Notifications then
    SendNotification("OZL - injecting OZL")
    wait(3.5)
    SendNotification("OZL - finished injecting OZL")
end
